    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider wrapperLookup, RecipeOutput recipeExporter) {
        return new RecipeProvider(wrapperLookup, recipeExporter) {
            ...
            public void buildRecipes() {
                ...
                // Smelting
                oreSmelting(List.of(WeaponryItems.COPPER_GREATSWORD), RecipeCategory.MISC, CookingBookCategory.MISC, Items.COPPER_NUGGET, 0.1f, 200, "copper_nugget_from_smelting_copper_gear");
                oreSmelting(List.of(WeaponryItems.IRON_GREATSWORD), RecipeCategory.MISC, CookingBookCategory.MISC, Items.IRON_NUGGET, 0.1f, 200, "iron_nugget_from_smelting_iron_gear");
                oreSmelting(List.of(WeaponryItems.GOLDEN_GREATSWORD), RecipeCategory.MISC, CookingBookCategory.MISC, Items.GOLD_NUGGET, 0.1f, 200, "gold_nugget_from_smelting_golden_gear");
            }
        };
    }
    @Override
